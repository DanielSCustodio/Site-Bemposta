...
*/
    class CTP_Settings
    {
        ...
        */
        ...
        {
            add_submenu_page('edit.php?post_type=cool_timeline','Cool Plugins Product Registration', 'Registration', 'manage_options', $this->AUTH_PAGE, array($this, 'auth_settings_page'));
        }
