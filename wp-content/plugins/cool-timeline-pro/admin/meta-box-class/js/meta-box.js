...
var _metabox_fields = {
  ...
  init: function(){
    ...
    // repater Field
    c(".at-re-toggle").on('click', function() {
  ...
  load_time_picker: function(){
    c('.at-time').each( function() {
      ...
      cthis.ctltimepicker( { showSecond: true, timeFormat: format, ampm: aampm } );
    ...
    function init (){
      return {
        ...
        hooks:function(){
          ...
          c('.simplePanelimageUploadclear,.simplePanelfileUploadclear').on('click', function( event ){
            event.preventDefault();
