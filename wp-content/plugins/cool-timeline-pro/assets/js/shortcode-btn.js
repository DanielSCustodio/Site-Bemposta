	...
	tinymce.PluginManager.add( 'cool_timeline', function( editor, url ) {
		...
		var timeline_designs={
			"designs":[
				...
				{"text":"Minimal Design","value":"design-7"}
			  ]
		  }
		  var c_timeline_designs={
			"designs":[
				{"text":"Default","value":"default"},
				{"text":"Flat Design","value":"design-2"},
				{"text":"Classic Design","value":"design-3"},
						 ...
						 editor.windowManager.open( {
							 ...
							 },
							 {
								 ...
								 },
								 {
									...
									label: 'Add categories slug for filters eg(stories,our-history)',
									value:''
								},
								 {
									 type: 'listbox',
							 ...
							 editor.windowManager.open( {
								 ...
								 },
								 {
									 ...
									 },
									 {
										type: 'textbox',
										name: 'autoplayspeed',
										label: 'AutoPlay Slideshow Speed ?',
										value:3000
									},
									 {
										 type: 'textbox',
							 ...
							 editor.windowManager.open( {
								 ...
								 body: [
									 ...
									 },
									 {
										 ...
										 name: 'designs',
										 label: 'Timeline Designs',
										 'values':c_timeline_designs.designs
									 },
									 {
										 type: 'listbox',
										 name: 'timeline_skin',
